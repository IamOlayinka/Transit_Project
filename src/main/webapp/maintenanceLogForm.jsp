...
<form action="AddMaintenanceLogServlet" method="post">
    ...
    <label for="predictedDate">Predicted Date:</label>
    <input type="date" name="predictedDate" id="predictedDate" required>
    ...
    <input type="text" name="recommendation" id="recommendation">
