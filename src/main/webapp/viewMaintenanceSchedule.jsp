...
<body>
    ...
    %>
		<tr>
			...
			<td>
				...
				<form action="MarkMaintenanceCompletedServlet" method="post"
					style="display: inline;">
					<input type="hidden" name="id" value="<%= m.getId() %>"> <input
						type="submit" class="btn btn-complete" value="Mark Completed">
				</form> <% } %>

				<form action="DeleteMaintenanceServlet" method="post"
					style="display: inline;">
					<input type="hidden" name="id" value="<%= m.getId() %>"> <input
						type="submit" class="btn btn-delete" value="Delete">
				</form>
			</td>
		</tr>
		<%
	...
	<a class="add-maintenance-link" href="maintenanceLogForm.jsp">Add
		New Log</a>
