...
<body>
    ...
    <div class="section">
        ...
        %>
            ...
            <p><a class="clear-link btn-primary" href="ViewFuelEnergyLogsServlet">Clear Filter</a></p>
        <%
            } else {
                ...
                %>
                    <tr>
                        ...
                        <td class="action-links">
                            <a class="btn-edit" href="EditFuelEnergyLogServlet?id=<%= log.getId() %>">Edit</a>
                            <form action="DeleteFuelEnergyLogServlet" method="post" style="display:inline;">
        ...
        <a class="btn-primary" href="fuelEnergyLogForm.jsp">
            <i class="fa fa-plus-circle"></i> Add New Log
        </a>
    </div>
